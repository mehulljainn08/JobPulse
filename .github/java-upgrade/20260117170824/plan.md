...
## Project Information
- **Project path**: /Users/mehuljain/Desktop/JobPulse - AI Job Scraper + Email Alerts/JobPulse
- **Working branch**: appmod/java-upgrade-20260117170824
...
- **Source JDK path (Java 17)**: /Library/Java/JavaVirtualMachines/temurin-17.jdk/Contents/Home/bin
- **Target JDK path (Java 21)**: /opt/homebrew/Cellar/openjdk@21/21.0.8/libexec/openjdk.jdk/Contents/Home/bin
- **Build tool type**: Maven Wrapper
- **Build tool path**: /Users/mehuljain/Desktop/JobPulse - AI Job Scraper + Email Alerts/JobPulse
...
1. Set up the development environment using tool #setup_upgrade_environment.
    ...
    - Create working branch `appmod/java-upgrade-20260117170824`.
